  ...
  return (
    <div className="bg-black text-white min-h-screen px-6 py-12 md:px-24 md:py-16">
      ...
      <section>
        ...
        <p>Pour toute information relative à la collecte et au traitement de vos données, veuillez consulter notre <a href="/conditions-et-confidentialite" className="text-blue-400 underline">Politique de confidentialité</a>.</p>
      </section>
    </div>
  );
}