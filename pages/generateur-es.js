  ...
  <div className="space-y-4">
    <div className="flex items-start gap-4">
      ...
      <p className="text-white leading-relaxed">
        Conecta tu cuenta de <strong>Spotify</strong> para que la playlist se cree directamente en tu perfil.
      </p>
    </div>
    <div className="flex items-start gap-4">
    ...
    {playlistUrl && (
      <div className="mt-10 text-center bg-[#1c1c1c] p-6 rounded-xl shadow-xl border border-green-500 animate-fade-in">
        <div className="flex items-center justify-center gap-2 mb-3">
          ...
          <p className="text-green-400 font-semibold text-lg">Tu playlist ha sido creada con éxito</p>
        </div>
        <a
          href={playlistUrl}
          target="_blank"
