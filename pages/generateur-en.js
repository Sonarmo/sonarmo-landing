...
export default function Generateur() {
  ...
  {credits !== null && credits <= 1 && (
    <div className="mt-10 flex flex-col items-center animate-fade-in text-center max-w-sm">
      <p className="text-sm text-pink-300 mb-6">
        Don&apos;t you have enough credits left to generate new playlists?<br />
  ...
  {promptHistory.length === 0 && (
    <div className="mt-20 text-center text-gray-400">
      <p>You have not yet generated a playlist.<br /> Go ahead and discover the sound magic of Sonarmo!</p>
    </div>
  )}
</main>
